// Protomaker Sprint temperature.cpp
...
void Temperature::isr() {
  ...
  void Temperature::print_heater_states(const int8_t target_extruder
    ...
    /* Protomaker Sprint M190 R wait for Heat Bed to cool down fix
       Increase twenty times. I am asuming this is seconds.
      ...
      ; for cooldown M116 Hl ;wait for heatbed to reach 32
      ; M116 Hl ;wait for heatbed to reach 32
      M140 S0 ; make sure the bed is turned off.
   */
      #define MIN_COOLING_SLOPE_TIME_BED 1200 // Protomaker Sprint M190 R wait for Heat Bed to cool down fix  WAS 60
    #endif
