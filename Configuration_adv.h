// Protomaker Sprint Configuration_adv.h
 ...
 */
// #define EXTRUDER_RUNOUT_PREVENT // Protomaker Sprint incompatible with ADVANCED_PAUSE_FEATURE.
 ...
 */
#define FAN_KICKSTART_TIME 250  // Protomaker Sprint To allow low speed start up of Part Blowing fan
#define FAN_KICKSTART_POWER 255 // 64-255 Protomaker Sprint Fan full power
...
#define BLTOUCH_DELAY 500 // Protomaker Sprint genuine Antclabs BLTouch V3.1 Ref: https://www.makenprint.uk/3d-printing/3d-printing-guides/skr-vl-4-configuration-adv-marlin-2-setup-part-3/
...
// #define BLTOUCH_FORCE_SW_MODE // Protomaker Sprint, longer pluses to allow for noisy signals unsheiled cables
 ...
 */
// #define BLTOUCH_HS_MODE tru  // #define BLTOUCH_HS_MODE true // Protomaker Sprint, may cause issues so not tried information https://www.3dprintbeast.com/bltouch-high-speed-hs-mode/
 ...
 */
// #define Z_STEPPER_AUTO_ALIGN // Protomaker Sprint suggested for Bigtree Tech TFT35 Display BUT if used causes error #error "Z_STEPPER_AUTO_ALIGN requires NUM_Z_STEPPER_DRIVERS greater than 1."
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING // Protomaker Sprint
...
#define PROBE_OFFSET_WIZARD // Protomaker Sprint // Add a Probe Z Offset calibration option to the LCD menu
...
#if HAS_BED_PROBE // Protomaker Sprint ABL offset guide including new probe Z offset wizard https://youtu.be/fN_ndWvXGBQ?t=391
...
#define STATUS_MESSAGE_SCROLLING // Protomaker Sprint. Longer text messages rotating on LCD display
...
// #define LCD_SHOW_E_TOTAL // Protomaker Sprint Seems to overwrite X,Y postions on the display. Don't bother
...
#define SET_PROGRESS_MANUALLY // Protomaker Sprint
...
#define SHOW_REMAINING_TIME   // Protomaker Sprint  Display estimated time to completion
...
#define EVENT_GCODE_SD_ABORT "G1 Z200 F12000\nG1 X0 Y350  F18000" // G-code to run on SD Abort Print (e.g., "G28XY" or "G27") // Protomaker Sprint Note New Lines, ( \n ) required. Out the way of the bed.  Z 200 hight; X 0 left; Y 350  back. "STOP Print" on LCD 12864
 ...
 * point in the file.
 */
#define POWER_LOSS_RECOVERY // Protomaker Sprint BTT UPS unit Pin PC0
#if ENABLED(POWER_LOSS_RECOVERY)
#define PLR_ENABLED_DEFAULT true // Protomaker Sprint Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)
#define BACKUP_POWER_SUPPLY      // Protomaker Sprint Backup power / UPS to move the steppers on power loss
#define POWER_LOSS_ZRAISE 5      // Protomaker Sprint WAS 2 // (mm) Z axis raise on resume (on power loss with UPS), 5 to help stop blobs
#define POWER_LOSS_PIN PC0       // Protomaker Sprint Pin to detect power loss. Set to -1 to disable default pin on boards without module.
...
#define LONG_FILENAME_HOST_SUPPORT // Protomaker Sprint suggested for Bigtree Tech TFT35 Display. Get the long filename of a file/folder with ’M33 with 'M33 <dosname>' and list long filenames with 'M20 L'
...
#define AUTO_REPORT_SD_STATUS // Protomaker Sprint suggested for Bigtree Tech Auto-report media status with 'M27 S<seconds>'
 ...
 */
#define SDCARD_CONNECTION ONBOARD // Protomaker Sprint Use the onboard SD Card reader, on the BTT Octopus Vl.l. NOT the LCD Bigtree Tech TFT35 card reader. Suggested for the Bigtree Tech TFT35 Display
 ...
 */
#define BABYSTEPPING // Protomaker Sprint Babystepping Enable graphical overlay on Z-offset editor
...
#define BABYSTEP_ZPROBE_OFFSET // Protomaker Sprint  // Combine M851 Z and Babystepping Enable graphical overlay on Z-offset editor
#if ENABLED(BABYSTEP_ZPROBE_OFFSET)
// #define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
#define BABYSTEP_ZPROBE_GFX_OVERLAY // Protomaker Sprint // Enable graphical overlay on Z-offset editor
#endif
#endif
 ...
 */
// #define LIN_ADVANCE // Protomaker Sprint Using S_CURVE_ACCELERATION can't use both
 ...
 */
// #define G29_RETRY_AND_RECOVER // Protomaker Sprint Ref: https://www.makenprint.uk/3d-printing/3d-printing-guides/skr-vl-4-configuration-adv-marlin-2-setup-part-3/
...
// G2/G3 Arc Support
//
// #define ARC_SUPPORT                   // Requires ~3226 bytes  // Protomaker Sprint Causes Stuck on supports Ref: https://youtu.be/crNU6UoBsKA
...
#define BLOCK_BUFFER_SIZE 8 // Protomaker Sprint Do NOT make too big or LCD12864 will not display Store option
#elif ENABLED(SDSUPPORT)
#define BLOCK_BUFFER_SIZE 64 // Protomaker Sprint 32 bit board should have more curve storage
#else
#define BLOCK_BUFFER_SIZE 64 // Protomaker Sprint 32 bit board should have more curve storage
#endif
 ...
 */
#define EMERGENCY_PARSER // Protomaker Sprint suggested for the Bigtree Tech TFT35 display
...
#define SERIAL_FLOAT_PRECISION 4 // Protomaker Sprint required for BigtreeTech TFT35 display
 ...
 */
// #define FWRETRACT // Protomaker Sprint offer Retraction on the fly
 ...
 */
#define ADVANCED_PAUSE_FEATURE // Protomaker Sprint required for Bigtree Tech TTFT35 display
...
#define FILAMENT_CHANGE_UNLOAD_LENGTH 700    // Protomaker Sprint Bowden Tube   (mm) The length of filament for a complete unload.
...
#define FILAMENT_CHANGE_FAST_LOAD_LENGTH 600 // Protomaker Sprint (mm) Load length of filament, from extruder gear to nozzle. Bowden Tube. Most the way if not enough able to purge more. // (mm) Load length of filament, from extruder gear to nozzle. For Bowden, the full length of the tube and nozzle
...
#define PARK HEAD ON PAUSE // Protomaker Sprint required for Bigtree Tech TFT35 display . Park the nozzle during pause and filament change.
                           // #define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

#define FILAMENT_LOAD_UNLOAD_GCODES // Protomaker Sprint required for Bigtree Tech TFT35 display // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
 ...
 */
#define CHOPPER_TIMING CHOPPER_DEFAULT_24V // Protomaker Sprint  All axes (override below) // Creality Ender 5 Plus  PSU Voltage BTT Octopus V1.1 board.
 ...
 */
#define MONITOR_DRIVER_STATUS // Protomaker Sprint if steppers overheat reduce current Ref : https://www.makenprint.uk/3d-printing/3d-printing-guides/skr-vl-4-configuration-adv-marlin-2-setup-part-3/
 ...
 */
#define AUTO_REPORT_POSITION // Protomaker Sprint suggested for Bigtree Tech TFT35 Display
...
#define M115_GE0METRY_REP0RT // Protomaker Sprint suggested for Bigtree Tech TFT35 Display
#endif
...
#define M114_DETAIL // Protomaker Sprint suggested for Bigtree Tech Use 'M114` for details to check planner calculations
// #define M114_REALTIME       // Real current position based on forward kinematics
// #define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE // Protomaker Sprint suggested for Bigtree Tech TFT35 Display // Report the new fan speed when changed by M106 (and others)
 ...
 */
#define HOST_ACTION_COMMANDS // Protomaker Sprint This is for OctoPrint, so 3D Printer is able to report issues RE: https://c0mmunity.0ct0print.0rg/t/0ct0print-tells-me-my-firmware-lacks-supp0rt-f or-host-action-commands-what-does-this-mean/34588 Also suggested for Bigtree Tech TFT35 Display
#if ENABLED(HOST_ACTION_COMMANDS)
// #define HOST_PAUSE_M76                // Tell the host to pause in response to M76
#define HOST_PROMPT_SUPPORT // Protomaker Sprint suggested for Bigtree Tech TFT35 Display Initiate host prompts to get user feedback
