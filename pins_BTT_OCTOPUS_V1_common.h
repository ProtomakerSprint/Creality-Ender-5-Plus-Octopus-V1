// Protomaker Sprint pins_BTT_OCTOPUS_V1_common.h
...
// Servos
//
#define SERVO0_PIN PB6 // Protomaker Sprint BLTouch
// Protomaker Sprint 3 servo's Servo index starts with 0 for M280 command One for BLTouch One for Nozzle Wipe
// Typical command to move Nozzle Wipe servo M280 Pl S90
// Using the New Servo, this resloved the jitter issue...
// TowerPro SG5010 Digital Servo Motor 5.5kg/cm 4.8V 180 Futaba
// Flux Workshop eBay seller : fluxworkshop

// NOTE: because End Stop use a 3.3 Voltage I only use one pin PG15 for the Servo signal. Port DIAG7 End Stop
// Then I use the PROBE (140) Two wires. Positive and Negative set to 5 Volts, on 138, for a 5 Volt power to this servo
 
#define SERVO1_PIN PG15  // Protomaker Sprint for Servo Nozzle Wipe for signal.  Comment out so it doesn't clash this line ====>	  #define E3_DIAG_PIN                         PG15  // E3DET
...
// Protomaker Spint Comment Out:  this pin is used for Wipe Nozzle SERVO1 #define E3_DIAG_PIN                         PG15  // E3DET
